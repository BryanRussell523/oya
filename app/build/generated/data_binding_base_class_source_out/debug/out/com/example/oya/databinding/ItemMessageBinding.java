...
public final class ItemMessageBinding implements ViewBinding {
  ...
  private ItemMessageBinding(@NonNull LinearLayout rootView, @NonNull LinearLayout layout,
      @NonNull TextView message, @NonNull TextView sender) {
  ...
  public static ItemMessageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemMessageBinding((LinearLayout) rootView, layout, message, sender);
    }
