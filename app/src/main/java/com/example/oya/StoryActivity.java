...
public class StoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Oya/Story");  // provide compatibility to all the versions
        ...
        Button storyprofile = (Button) findViewById(R.id.storyprofile);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.settings:
                //ADD INTENT TO LOAD SETTINGS ACTIVITY
                Intent settingsintent = new Intent(StoryActivity.this, Settings.class);
